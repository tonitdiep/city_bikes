...
class API
    def self.fetch_stations
        ...
        array_of_stations[0..100].each do {|station_hash|} 
            ...
            station_hash.each = Bike.new[empty_slots:, free_bikes:, name:]
            Bike.new.station_hash = { 
                staton_hash.empty_slots = station_hash["empty_slots"]
                station_hash.free_bikes = station_hash["free_bikes"]
                station_hash.name = station_hash["name"]
            }
